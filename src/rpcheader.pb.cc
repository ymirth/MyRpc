...
static void InitDefaultsscc_info_rpcheader_rpcheader_2eproto() {
  ...
  {
    void* ptr = &::rpcheader::_rpcheader_default_instance_;
    new (ptr) ::rpcheader::rpcheader();
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_rpcheader_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::rpcheader::rpcheader, request_size_),
};
...
const char descriptor_table_protodef_rpcheader_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\017rpcheader.proto\022\trpcheader\"L\n\trpcheade"
  "r\022\024\n\014service_name\030\001 \001(\014\022\023\n\013method_name\030\002"
  " \001(\014\022\024\n\014request_size\030\003 \001(\rb\006proto3"
  ;
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_rpcheader_2eproto = {
  false, false, descriptor_table_protodef_rpcheader_2eproto, "rpcheader.proto", 114,
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 24)) {
          request_size_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* rpcheader::_InternalSerialize(
  ...
  if (this->request_size() != 0) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(3, this->_internal_request_size(), target);
  }
